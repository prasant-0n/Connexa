...
import { BiImages, BiSolidVideo, BiFiletypeGif } from "react-icons/bi";
...
export default function Home() {
  ...
  return (
    <>
      <div className=" home w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-bgColor  h-full overflow-hidden">
        <TopBar />
        <div className="w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full">
          ...
          <div className="hidden w-1/4 lg:w1/4 h-full md:flex flex-col gap-6 overflow-y-auto ">
            ...
            {/* <div className="lg:hidden w-full sm:w-1/4 h-full flex flex-col gap-8 overflow-y-auto">
              {/* Friend-Request */}
                  ...
                  {friendRequest?.map(({ _id, requestFrom: from }) => (
                    ...
                    >
                      ...
                      <div className="flex gap-1">
                        <CustomButton
                          title="Accept"
                          containerStyles="bg-[#0444a4] text-xs text-ascent-1 px-1.5 py-1 rounded-full"
                        />
                        <CustomButton
                          title="Deny"
          ...
          <div className="flex-1 h-full  px-4 flex flex-col gap-6 overflow-y-auto">
            ...
            >
              <div className="w-full flex items-center gap-2 py-4 border-b border-[#66666645]">
                ...
                />
                <TextInput
                  styles="w-80 rounded-full py-1.5 ml-4"
